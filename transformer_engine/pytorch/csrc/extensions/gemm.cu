...
void te_gemm_msamp(at::Tensor A,
  ...
  auto te_B = makeTransformerEngineTensor(B.data_ptr(),
                                          ...
                                          B_type, nullptr, nullptr,
                                          B_scale_inverse.data_ptr());
  auto te_C = makeTransformerEngineTensor(C.data_ptr(),
                                          {static_cast<size_t>(C.size(0)),
                                           static_cast<size_t>(C.size(1))},
                                          transformer_engine::DType::kBFloat16, nullptr, nullptr,
                                          nullptr);
  auto te_D = makeTransformerEngineTensor(D.data_ptr(),
                                          {static_cast<size_t>(D.size(0)),
                                           static_cast<size_t>(D.size(1))},
  ...
  nvte_cublas_gemm_msamp(te_A.data(),
                   te_B.data(),
                   te_C.data(), 
                   te_D.data(),
                   te_bias.data(),
